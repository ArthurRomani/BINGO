...
function updateParticipantTables() {
  ...
  participants.forEach((participant, index) => {
    ...
    participant.numbers.forEach((number, i) => {
      ...
      // Define o conteúdo da célula do meio como "X"
      if (i === 12) {
        cell.textContent = "X";
      ...
      // Verifica se o número sorteado está na tabela do participante e marca a célula correspondente
...
// Chamada inicial para atualizar as tabelas de participantes vazias
updateParticipantTables();
